...
const swagger = require('./app/libs/swagger/swagger');
//const swagger = require('./app/libs/swagger/autogen'); //err :Router.use() requires a middleware function but got a undefined
